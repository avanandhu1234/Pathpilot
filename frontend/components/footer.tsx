...
const footerLinks = {
  ...
  employers: {
    ...
    links: [
      ...
      { href: "/recruitment-solutions", label: "Recruitment Solutions" },
      { href: "/employer-resources", label: "Employer Resources" },
    ],
  },
  company: {
    title: "Company",
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Your trusted partner in career advancement and job search success.
            </p>
          </div>
