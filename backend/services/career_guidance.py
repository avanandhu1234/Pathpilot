"""
Career guidance: target role -> skills, tools, certifications, roadmap.
Uses OpenAI via services/llm when OPENAI_API_KEY is set.
"""
import json
import re
...
def get_guidance(target_role: str) -> dict:
    ...
    Calls OpenAI; falls back to default structure if no key or parse error.
    """
    system = (
